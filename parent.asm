...
int main(void)
{
   ...
   e:	51                   	push   %ecx
	int ChildPid = fork();
   f:	e8 a6 02 00 00       	call   2ba <fork>
	if(ChildPid<0)
  ...
  1c:	e8 21 03 00 00       	call   342 <getpid>
  21:	53                   	push   %ebx
  22:	50                   	push   %eax
  ...
  2a:	e8 f1 03 00 00       	call   420 <printf>
		wait();
  2f:	e8 96 02 00 00       	call   2ca <wait>
  34:	83 c4 10             	add    $0x10,%esp
	...
	else
	{
		 ...
		 exit();
  37:	e8 86 02 00 00       	call   2c2 <exit>
		 printf(1,"I am the Child. My pid is %d, parent id is %d\n",getpid(),getppid());
  3c:	e8 31 03 00 00       	call   372 <getppid>
  41:	89 c3                	mov    %eax,%ebx
  43:	e8 fa 02 00 00       	call   342 <getpid>
  48:	53                   	push   %ebx
  49:	50                   	push   %eax
  4a:	68 b8 07 00 00       	push   $0x7b8
  4f:	6a 01                	push   $0x1
 ...
 389:	85 d2                	test   %edx,%edx
{
 ...
 3b7:	f7 f1                	div    %ecx
 3b9:	0f b6 92 f0 07 00 00 	movzbl 0x7f0(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, char *fmt, ...)
{
 ...
 5d4:	e9 8f fe ff ff       	jmp    468 <printf+0x48>
          s = "(null)";
 5d9:	bb e8 07 00 00       	mov    $0x7e8,%ebx
        while(*s != 0){
 ...
 5f1:	a1 98 0a 00 00       	mov    0xa98,%eax
{
 ...
 62d:	89 08                	mov    %ecx,(%eax)
  freep = p;
 62f:	a3 98 0a 00 00       	mov    %eax,0xa98
}
 634:	5b                   	pop    %ebx
 635:	5e                   	pop    %esi
 636:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
 ...
 6cf:	73 47                	jae    718 <malloc+0x98>
    ...
    if(p == freep)
 6d1:	39 05 98 0a 00 00    	cmp    %eax,0xa98
 ...
 6f6:	e8 f5 fe ff ff       	call   5f0 <free>
  return freep;
 6fb:	8b 15 98 0a 00 00    	mov    0xa98,%edx
 ...
 724:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 727:	89 15 98 0a 00 00    	mov    %edx,0xa98
}
 ...
 747:	0a 00 00 
 74a:	c7 05 9c 0a 00 00 9c 	movl   $0xa9c,0xa9c
 751:	0a 00 00 
    base.s.size = 0;
 754:	b8 9c 0a 00 00       	mov    $0xa9c,%eax
