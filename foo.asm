  ...
  19:	83 39 01             	cmpl   $0x1,(%ecx)
{
  ...
  3b:	e8 50 04 00 00       	call   490 <printf>
            wait();
  40:	e8 f5 02 00 00       	call   33a <wait>
  45:	83 c4 10             	add    $0x10,%esp
    for(k=0; k<n; k++)
  48:	39 df                	cmp    %ebx,%edi
  4a:	7e 34                	jle    80 <main+0x80>
        id = fork();
  4c:	e8 d9 02 00 00       	call   32a <fork>
        if(id < 0)
  ...
  55:	79 d1                	jns    28 <main+0x28>
            printf(1, "%d failed in fork!\n", getpid());
  57:	e8 56 03 00 00       	call   3b2 <getpid>
  5c:	83 ec 04             	sub    $0x4,%esp
    for(k=0; k<n; k++)
  5f:	83 c3 01             	add    $0x1,%ebx
            printf(1, "%d failed in fork!\n", getpid());
  62:	50                   	push   %eax
  63:	68 e8 07 00 00       	push   $0x7e8
  68:	6a 01                	push   $0x1
  6a:	e8 21 04 00 00       	call   490 <printf>
  6f:	83 c4 10             	add    $0x10,%esp
    for(k=0; k<n; k++)
  72:	39 df                	cmp    %ebx,%edi
  74:	7f d6                	jg     4c <main+0x4c>
  ...
  79:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
    ...
    exit();
  80:	e8 ad 02 00 00       	call   332 <exit>
  ...
  a1:	e8 0c 03 00 00       	call   3b2 <getpid>
  a6:	52                   	push   %edx
  a7:	50                   	push   %eax
  a8:	68 19 08 00 00       	push   $0x819
  ad:	6a 01                	push   $0x1
  af:	e8 dc 03 00 00       	call   490 <printf>
            for(z=0;z<8000000.0;z+=0.001)
  b4:	d9 ee                	fldz   
            printf(1, "Child %d created\n", getpid());
  b6:	83 c4 10             	add    $0x10,%esp
            for(z=0;z<8000000.0;z+=0.001)
  b9:	dd 05 30 08 00 00    	fldl   0x830
  bf:	90                   	nop
  c0:	dc c1                	fadd   %st,%st(1)
  c2:	d9 05 38 08 00 00    	flds   0x838
...
printf(int fd, char *fmt, ...)
{
 ...
 644:	e9 8f fe ff ff       	jmp    4d8 <printf+0x48>
          s = "(null)";
 649:	bb 3c 08 00 00       	mov    $0x83c,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 661:	a1 f4 0a 00 00       	mov    0xaf4,%eax
{
 ...
 69d:	89 08                	mov    %ecx,(%eax)
  freep = p;
 69f:	a3 f4 0a 00 00       	mov    %eax,0xaf4
}
 6a4:	5b                   	pop    %ebx
 6a5:	5e                   	pop    %esi
 6a6:	5f                   	pop    %edi
 ...
 6b6:	72 ce                	jb     686 <free+0x26>
{
 ...
 6d7:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 6da:	a3 f4 0a 00 00       	mov    %eax,0xaf4
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6f9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6fc:	8b 15 f4 0a 00 00    	mov    0xaf4,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 73f:	73 47                	jae    788 <malloc+0x98>
    ...
    if(p == freep)
 741:	39 05 f4 0a 00 00    	cmp    %eax,0xaf4
 ...
 766:	e8 f5 fe ff ff       	call   660 <free>
  return freep;
 76b:	8b 15 f4 0a 00 00    	mov    0xaf4,%edx
 ...
 794:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 797:	89 15 f4 0a 00 00    	mov    %edx,0xaf4
}
 ...
 7b7:	0a 00 00 
 7ba:	c7 05 f8 0a 00 00 f8 	movl   $0xaf8,0xaf8
 7c1:	0a 00 00 
    base.s.size = 0;
 7c4:	b8 f8 0a 00 00       	mov    $0xaf8,%eax
